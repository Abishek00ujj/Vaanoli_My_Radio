   ...
   const handleBack=()=>{
    ...
    return (
      <>
        ...
        <div className="w-[400px] h-[400px]  shadow-[0_0_20px_1px_rgba(255,255,20,0.8)] bg-slate-400/10 backdrop-blur-3xl rounded-xl flex justify-center items-center">
               <img src={song} alt=""/>
        </div>
        <div>
        <audio autoPlay controls className='w-[400px] h-20 rounded-lg'>
            <source src={data.src} type="audio/mpeg" className='bg-green-400'/>
        </audio>
        </div>
        </div>
      </>
